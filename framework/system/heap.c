...
{
    if (t1->next_tick.tv_sec < t2->next_tick.tv_sec) return -1;
    else if (t1->next_tick.tv_sec > t2->next_tick.tv_sec) return 1;
    else if (t1->next_tick.tv_usec < t2->next_tick.tv_usec) return -1;
    else if (t1->next_tick.tv_usec > t2->next_tick.tv_usec) return 1;
    return 0;
}
