...
static const char *COLORS[] = {LOG_COLOR_E, LOG_COLOR_W, LOG_COLOR_I, LOG_COLOR_D, LOG_COLOR_V};
...
#endif
    snprintf(prefix, LOG_PREFIX_BUF_SIZE, "%s.%03d [%s] %s:%d",
             buffer, millisec, str_level(level), strip_path(filename), line);
